...
.service('lastPostCommentsService', ['$firebase', '$q', '$localStorage', '$timeout', '$rootScope', '$http', 'getSubsService', function($firebase, $q, $localStorage, $timeout, $rootScope, $http, getSubsService){
